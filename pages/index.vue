    ...
    <section class="container mx-auto text-xl leading-9">
      <div class="mb-16 max-w-6xl px-4 mx-auto">
        ...
        <p class="intro mb-20 mx-auto sm:max-w-2xl text-center">
          <b>La cooperativa Multiactiva Bio - arcoíris R.L.</b>, es una organización de primer nivel. <b>Fundada en 2019</b>, que agrupamos a <b>100
...
orgánico especial
            ...
            <p class="md:text-left text">
              En grano y también transformado con su
marca ARCOIRIS, en tostado y molido.
        ...
        <div class="flex flex-col mb-8 sm:flex-row text-base">
          ...
          <div class="flex flex-col justify-center mb-8 md:w-7/12 sm:pr-16 sm:w-1/2">
            ...
            <p class="md:text-left text">
              Precipitación media anual de 1.800 mm, Humedad relativa 70-80%, con temperatura promedio 25°C y una altura de 550m hasta 1880 m.s.n.m.
            </p>
          </div>
        </div>
      </div>
    </section>
    <section class="bg-gray-100 mx-auto text-xl leading-9 pb-12">
      <Contacto></Contacto>
    </section>
  </div>
</template>
